...
struct  DataObjectMethodType_t1069349368 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DataObjectMethodType_t1069349368, ___value___1)); }
