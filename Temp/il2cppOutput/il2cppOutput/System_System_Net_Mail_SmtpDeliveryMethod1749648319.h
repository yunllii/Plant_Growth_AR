...
struct  SmtpDeliveryMethod_t1749648319 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SmtpDeliveryMethod_t1749648319, ___value___1)); }
