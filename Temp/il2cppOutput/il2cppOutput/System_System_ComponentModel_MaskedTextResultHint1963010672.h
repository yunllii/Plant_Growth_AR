...
struct  MaskedTextResultHint_t1963010672 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MaskedTextResultHint_t1963010672, ___value___1)); }
