...
struct  PropertyTabScope_t2485003348 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(PropertyTabScope_t2485003348, ___value___1)); }
